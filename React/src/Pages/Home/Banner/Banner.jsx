...
import BannerIMG3 from "../../../assets/banner/Home-Page-Banner-1.webp";
...
const Banner = () => {
  ...
  const handleSubmitFlight = async (e) => {
    ...
    if (flightType === "ROUND-TRIP" && !checkoutFlight) {
      toast.error("Return Date is required for a Round-Trip flight.");
      return;
    }
  ...
  return (
    <div>
      {loading ? (
        ...
        <div className="bg-cover bg-center h-[1000px] lg:h-[750px] px-2 ">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="rounded-lg">
                <div className="flex flex-col lg:flex-row justify-center  mx-auto w-full xl:w-[1300px] ">
                  <div className=" rounded-lg  md:w-[650px] lg:w-[100%] xl:w-[70%]  mx-auto ">
                    {/* Tab Headers */}
                    <div className="flex gap-1">
                      <button
                        className={`px-2 md:px-4 md:py-2  text-text_small md:text-text_title flex items-center justify-center md:gap-2 font-bold rounded-t-md ${
                          activeTab === "Tour"
                            ? "bg-clr_primary_text text-white"
                            : "bg-white text-black"
                        }`}
                    ...
                    <div className="bg-purple_dark p-p_16px">
                            ...
                            <div>
                              ...
                              <Select
                                ...
                                value={nationalOptions.find(
                                  (option) =>
                                    option.value === selectedNationality
                                )}
                                onChange={(selectedOption) =>
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 ">
                            <div>
                              ...
                              <Select
                                ...
                                value={countryOptions.find(
                                  (option) =>
                                    option.value === selectedCountryVisa
                                )}
                                onChange={(selectedOption) =>
                      ...
                      {activeTab === "Hotel" && (
                        <div>
                          <form
                            className="p-4 bg-[#5A4A8A] rounded-md"
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className="p-1.5 bg-white text-black rounded w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  type="date"
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setCheckOutFlight(e.target.value)
                                  }
                                  className={` bg-white text-black rounded w-full focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                                    flightType === "One-Way"
                                      ? "disabled:bg-gray-300 disabled:text-gray-700 p-2"
                                      : "p-1.5"
                                  }`}
                                  type={flightType === "One-Way" ? "" : "date"}
