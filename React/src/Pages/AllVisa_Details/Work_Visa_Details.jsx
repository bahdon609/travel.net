...
import Visit_Visa_Tab from "./Visit_Visa_Tab/Visit_Visa_Tab";
import Work_Visa_Tab from "./Work_Visa_Tab/Work_Visa_Tab";

const Work_Visa_Details = () => {
  ...
  const { data = {}, refetch } = useQuery({
    queryKey: ["work visa details"],
    queryFn: async () => {
      const res = await axiosPublic(`/single-working-visa-data/${id}`);
      return res.data;
    },
  });
  //(data);
      ...
      <div>
        {loading ? (
          ...
          <Parallax
            ...
            bgImage={data?.singleWorkingVisaData?.photo_1}
            ...
            >
              ...
              >
                <h1 className="text-4xl font-bold mb-4 w-full h-full">
                  {data?.singleWorkingVisaData?.title}
                </h1>
              </div>
            </div>
          </Parallax>
            ...
            <div className="w-full lg:w-[70%]">
              <div className="bg-white h-[400px] overflow-hidden">
                <img
                  ...
                  src={data?.singleWorkingVisaData?.photo_1}
                  alt="Umrah Package"
              ...
              <div className="w-full mt-m_24px  bg-white shadow-lg ">
                <Work_Visa_Tab data={data}></Work_Visa_Tab>
              </div>
            </div>
            ...
            <div className="w-full lg:w-[30%] bg-white">
                ...
                <div className="border p-p_16px ">
                  {/* <p className="text-text_title">
                    ...
                    <span className="font-bold text-sky_blue">
                      {stripHtml(data?.singleWorkingVisaData?.package_price)}{" "}
                    </span>{" "}
                    Per Person
                  </p> */}
              ...
              <div className="mt-m_24px">
                <div>
                  ...
                  <div>
                    {data?.moerWorkingVisaData?.map((pkg, index) => (
                      <Link
...
export default Work_Visa_Details;
