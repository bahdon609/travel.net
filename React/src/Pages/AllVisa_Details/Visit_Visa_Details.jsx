...
const Visit_Visa_Details = () => {
  ...
  const { data = {}, refetch } = useQuery({
    queryKey: ["visit visa details"],
    queryFn: async () => {
      const res = await axiosPublic(`/single-visa-service-data/${id}`);
      return res.data;
    },
  });
  //(data);
      ...
      <div>
        {loading ? (
          ...
          <Parallax
            ...
            bgImage={data?.singleVisaServiceData?.photo_1}
            ...
            >
              ...
              >
                <h1 className="text-4xl font-bold mb-4 w-full h-full">
                  {data?.singleVisaServiceData?.title}
                </h1>
              </div>
            </div>
          </Parallax>
            ...
            <div className="w-full lg:w-[70%]">
              <div className="bg-white h-[400px] overflow-hidden">
                <img
                  ...
                  src={data?.singleVisaServiceData?.photo_1}
                  alt="Umrah Package"
              ...
              <div className="w-full mt-m_24px  bg-white shadow-lg ">
                <Visit_Visa_Tab data={data}></Visit_Visa_Tab>
              </div>
            </div>
            ...
            <div className="w-full lg:w-[30%] bg-white">
                ...
                <div className="border p-p_16px ">
                  <p className="text-text_title">
                    ...
                    <span className="font-bold text-sky_blue">
                      {stripHtml(data?.singleVisaServiceData?.package_price)}{" "}
                    </span>{" "}
                    Per Person
                  </p>
              ...
              <div className="mt-m_24px">
                <div>
                  ...
                  <div>
                    {data?.moerVisaServiceData?.map((pkg, index) => (
                      <Link
...
export default Visit_Visa_Details;
