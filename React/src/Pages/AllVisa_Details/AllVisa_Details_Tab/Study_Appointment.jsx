...
const Study_Appointment = ({ data }) => {
  //(data)
  const axiosPublic = useAxiosPublic();
  const [formData, setFormData] = useState({
    study_visa_id: data?.singleStudyVisaData?.id, // Assuming a default value, modify as needed
    name: "",
    phone: "",
    email: "",
    date_of_birth: "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        setFormData({
          study_visa_id: data?.singleStudyVisaData?.id,
          name: "",
          phone: "",
          email: "",
          date_of_birth: "",
...
export default Study_Appointment;
