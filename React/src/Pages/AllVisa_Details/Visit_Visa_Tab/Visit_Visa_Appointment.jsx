...
const Visit_Visa_Appointment = ({ data }) => {
  //(data);
  const axiosPublic = useAxiosPublic();
  const [formData, setFormData] = useState({
    visa_service_id: data?.singleVisaServiceData?.id, // Assuming a default value, modify as needed
    name: "",
    phone: "",
    email: "",
    date_of_birth: "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        setFormData({
          visa_service_id: data?.singleVisaServiceData?.id,
          name: "",
          phone: "",
          email: "",
          date_of_birth: "",
...
export default Visit_Visa_Appointment;
