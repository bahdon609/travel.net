...
const NavTourSkelator = () => {
    return (
        <div>
            ...
            {/* multi country tours start */}
            <div>
                <div>
                    {/* Skeleton Title Button */}
                    <div className="flex items-center justify-center pt-p_60px">
                        <div className="py-p_8px px-p_20px bg-gray-300 rounded-sm w-[200px] h-10 animate-pulse"></div>
                    </div>
...
export default NavTourSkelator;